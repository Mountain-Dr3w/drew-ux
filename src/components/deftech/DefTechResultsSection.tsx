  ...
  return (
    <CaseStudySection title="Results & Impact">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
        <Card className="p-6 relative overflow-hidden border border-border">
      ...
      <Card className="p-8 border border-border mb-10">
      ...
      <Card className="mt-12 p-8 border border-border">
