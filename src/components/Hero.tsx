      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 w-full relative">
        ...
        <TransitionEffect direction="up" delay={0.1}>
          <div className="text-center mb-4 flex flex-wrap justify-center gap-2">
            ...
            <span className="inline-block text-sm font-medium px-3 py-1 rounded-full bg-purple-100/50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300">
              Product Strategy
            </span>
          </div>
        </TransitionEffect>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <TransitionEffect direction="up" delay={0.4}>
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <a
                href="#projects"
                className="group inline-flex items-center justify-center space-x-2 border border-black/10 dark:border-white/10 bg-transparent text-black dark:text-white px-6 py-3 rounded-full hover:bg-black/5 dark:hover:bg-white/5 transition-colors duration-300"
              >
