        ...
        <div className="flex flex-col items-center text-center">
          ...
          <TransitionEffect direction="up" delay={0.4}>
            <div className="flex flex-col sm:flex-row w-full sm:w-auto items-center justify-center gap-3 md:gap-4 mb-6">
              <a href="#contact" className="group inline-flex items-center justify-center bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-600/80 dark:to-blue-800/80 px-5 py-2 md:px-6 md:py-3 rounded-full hover:bg-blue-700 dark:hover:opacity-90 transition-all duration-300 w-full sm:w-auto min-w-[140px] h-10 md:h-12 whitespace-nowrap z-10 dark:border dark:border-white/10 hover:shadow-xl hover:shadow-blue-500/20 hover:scale-[1.02]">
                <span className="font-medium text-sm md:text-base text-white">Connect With Me</span>
              </a>
              
              <a href="#projects" className="group inline-flex items-center justify-center space-x-2 bg-gray-200/80 dark:bg-gray-800/20 backdrop-blur-xl text-gray-700 dark:text-gray-200 px-5 py-2 md:px-6 md:py-3 rounded-full hover:bg-gray-300 dark:hover:bg-gray-700/30 transition-all duration-300 w-full sm:w-auto min-w-[140px] h-10 md:h-12 whitespace-nowrap z-10 border border-gray-300 dark:border-white/10 shadow-xl hover:shadow-gray-500/10 hover:scale-[1.02]">
