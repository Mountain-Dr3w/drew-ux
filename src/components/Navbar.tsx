...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container max-w-6xl mx-auto flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            ...
            <span className="text-xl font-semibold">Drew<span className="text-blue-500">UX</span></span>
          </Link>
      ...
      {/* Mobile Menu */}
      <div 
        className={`fixed inset-0 bg-white dark:bg-black z-40 transform transition-transform duration-300 ${
